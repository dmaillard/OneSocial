	...
	function boss_support_tab_content() {
		...
		<div class="welcome-panel boss-support-area">
			<div class="welcome-panel-content">
				...
				<h3>Thanks for purchasing OneSocial! Here are some video tutorials to get you started:</h3>

				<div class="boss-video-container">
					<div class="boss-videoWrapper">
						<iframe width="672" height="378" src="https://www.youtube.com/embed/yOHI7SkdXEI?list=PL5kBYJSuuvEiDk6E_ZznfL5Se2ryH34Rf" frameborder="0" allowfullscreen></iframe>
					</div>
				</div>
