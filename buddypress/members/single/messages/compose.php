<form action="<?php bp_messages_form_action('compose' ); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<?php if ( bp_current_user_can( 'bp_moderate' ) ) : ?>
		<label for="send-notice" class="send-notice-label"><span class="btn"><input type="checkbox" id="send-notice" name="send-notice" value="1" /> </span><span class="text"><?php _e( "This is a notice to all users.", "onesocial" ); ?></span></label> 
	<?php endif; ?>
